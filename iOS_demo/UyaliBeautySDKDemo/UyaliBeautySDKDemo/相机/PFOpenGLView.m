...
- (UIColor*)getColorWithPoint:(CGPoint)point{
    ...
    dispatch_semaphore_t colorSemaphore = dispatch_semaphore_create(0);
    ...
    dispatch_async(_contextQueue, ^{
        ...
        dispatch_semaphore_signal(colorSemaphore);
    });
    dispatch_semaphore_wait(colorSemaphore, DISPATCH_TIME_FOREVER);
    return color;
}
